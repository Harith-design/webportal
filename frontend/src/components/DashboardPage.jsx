  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" >
        {[
          { title: "Total Orders", value: "201", icon: <ShoppingCart size={20} color="blue"/>, bg: "radial-gradient(circle at 30% 70%, #cfdfffff, #fffbf7ff)" },
          { title: "Past Due", value: "RM 2,100.50", icon: <ClockAlert size={20} color="#e63946" />, bg: "radial-gradient(circle at 30% 70%, #ffd7d7ff, #f8faffff)"},
          { title: "Due Soon", value: "RM 369.22", icon: <ClockFading size={20} color="green"/>, bg: "radial-gradient(circle at 30% 70%, #9ce9d9ff, #fefff7ff)"},
