    ...
    <div className="p-6 space-y-8 bg-white rounded-xl shadow-md">
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <div className ="flex items-center space-x-4">
          <label className="w-32 block text-sm font-medium mb-1">Name</label>
          <input
            type="text"
            name="name"
            value={formData.name}
        ...
        {/* Email */}
        <div className ="flex items-center space-x-4">
          <label className="w-32 block text-sm font-medium mb-1">Email</label>
          <input
            type="email"
            name="email"
        ...
        {/* Role */}
        <div className ="flex items-center space-x-4">
          <label className="w-32 block text-sm font-medium mb-1">Role</label>
          <input
            type="text"
            name="role"
            value={formData.role}
        ...
        {/* Company */}
        <div className ="flex items-center space-x-4">
          <label className="w-32 block text-sm font-medium mb-1">Company</label>
          <input
            type="text"
            name="company"
        ...
        {/* Contact */}
        <div className ="flex items-center space-x-4">
          <label className="w-32 block text-sm font-medium mb-1">Contact No</label>
          <input
            type="number"
            name="contact"
        ...
        {/* Password */}
        <div className ="flex items-center space-x-4">
          <label className="w-32 block text-sm font-medium mb-1">New Password</label>
          <input
            type="password"
            name="password"
